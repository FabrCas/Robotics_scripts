%string_joints_types -> 'r' or 'p'
% cell_I_ci -> is actually an array
function T = compute_kinetic_energy(string_joints_types, dhtable, array_q, array_q_dot, cell_ri_ci, array_m_i, cell_I_ci, v0_0, omega0_0, print_info)
    T = 0;
    n = length(array_q);
