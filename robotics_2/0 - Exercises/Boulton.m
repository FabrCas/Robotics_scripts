...
%% compute linear part of linear kinetic energy of joint 1 (theta, for bolton body)
pct = [0;0;h];
...
%% compute the linear part of kinetic energy of joint 2   (phi, for the two balls)
